...
const fetchDataFromRegistry_1 = __importDefault(
  require('./fetchDataFromRegistry'),
);
function executeHookActions(actionsList_1, currentContext_1) {
  return __awaiter(
    ...
    arguments,
    void 0,
    function* (actionsList, currentContext, index = 0) {
      ...
      return executeHookActions(
        actionsList,
        Object.assign(Object.assign({}, currentContext), {
...
const runHook = (trigger, orgId, inputContext) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const hook = yield (0, fetchDataFromRegistry_1.default)('/hook', {
      trigger,
      orgId,
    });
    if (!hook) {
