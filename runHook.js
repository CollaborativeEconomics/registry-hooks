...
function executeHookActions(actionsList_1, currentContext_1) {
    return __awaiter(this, arguments, void 0, function* (actionsList, currentContext, index = 0) {
        ...
        return executeHookActions(actionsList, Object.assign(Object.assign({}, currentContext), { [currentAction.key]: newData }), index + 1);
    });
}
const runHook = (triggerName, orgId, inputContext) => __awaiter(void 0, void 0, void 0, function* () {
    const hook = yield (0, fetchDataFromRegistry_1.default)('/hook', { triggerName, orgId });
    if (!hook) {
        console.log(`No hook found for org ${orgId} and trigger ${triggerName}`);
        return inputContext;
    }
    return yield executeHookActions(hook.actions, { input: inputContext });
});
